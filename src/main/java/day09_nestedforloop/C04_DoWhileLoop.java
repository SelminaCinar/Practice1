    ...
    */
    ...
    //eger 4 ten az muz kalirsa maymunlar olur.
        ...
        do {
            ...
            if(muzSayisi<4){
                maymunAlive=false;
                System.out.println("Bugun   " + survivalDays + "gun yasayamadın muz kalmadi üzdün beni :(" );
            }else System.out.println("Bugun  " + survivalDays + "gun yasadi muz henüz bitmedi ama sen yinede ciftcilik ogren lutfen!");
