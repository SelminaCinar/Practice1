...
*/
    ...
    public static void testsonucu(char[][] answers, char[] keys) {
        ...
        for (int i = 0; i < answers.length; i++) {// her bir ogrenciyi dolastik(ogrenciler)

            int sayac = 0;//her bir ogrencinin dogur cevap sayisi
            for (int j = 0; j < answers[i].length; j++) {//her ogrencinin cevaplarına bakar.(cevaplar)
